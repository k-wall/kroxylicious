...
import io.kroxylicious.proxy.config.PortIdentifiesNode;
import io.kroxylicious.proxy.config.SniHostIdentifiesNode;
        ...
        return Optional.ofNullable(cluster.listeners())
                ...
                .orElseGet(() -> {
                    ...
                    if (providerDefinition.config() instanceof PortPerBrokerClusterNetworkAddressConfigProviderConfig pc) {
                        var ppb = new PortIdentifiesNode(pc.getBootstrapAddress(),
                                pc.getBrokerAddressPattern(),
                                pc.getBrokerStartPort(),
                                null,
                                pc.getLowestTargetBrokerId(),
                                pc.getNumberOfBrokerPorts());
                        ...
                        var ranges = rc.getNodeIdRanges().stream()
                                ...
                                .toList();
                        var rap = new PortIdentifiesNode(rc.getBootstrapAddress(),
                        ...
                        var snp = new SniHostIdentifiesNode(sc.getBootstrapAddress(),
