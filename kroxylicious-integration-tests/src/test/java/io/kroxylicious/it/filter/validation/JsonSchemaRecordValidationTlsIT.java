...
class JsonSchemaRecordValidationTlsIT extends RecordValidationBaseIT {
    ...
    private static ConfigurationBuilder createSchemaValidationConfigWithoutTls(KafkaCluster cluster, Topic topic, Map<String, Object> apicurioRegistryUrl1) {
        String className = RecordValidation.class.getName();
        Map<String, Object> schemaValidationConfig = apicurioRegistryUrl1;
